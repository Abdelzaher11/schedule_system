...
import 'package:hti_graduation_project/screens/mobile_screens/examiner/final_screen.dart';
...
// ignore: use_key_in_widget_constructors
class MobileExaminerMenuScreen extends StatefulWidget {
  @override
  _MobileExaminerMenuScreenState createState() => _MobileExaminerMenuScreenState();
}

class _MobileExaminerMenuScreenState extends State<MobileExaminerMenuScreen> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(
                            builder: (context)=> MobileExaminerMidtermScreen(),
                          ));
                        },
                        child: Container(
                      ...
                      InkWell(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(
                            builder: (context)=>MobileExaminerFinalScreen(),
                          ));
                        },
                        child: Container(
                          clipBehavior: Clip.antiAliasWithSaveLayer,
