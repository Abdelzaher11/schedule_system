...
class MobileLectureAndSectionInputScreen extends StatefulWidget {
  @override
  _MobileLectureAndSectionInputScreenState createState() => _MobileLectureAndSectionInputScreenState();
}

class _MobileLectureAndSectionInputScreenState extends State<MobileLectureAndSectionInputScreen> {
                    ...
                    child: Container(
                      ...
                      child: MaterialButton(
                        onPressed: () {
                          ...
                          //  kFirstDurationLectureValue;
                          //  kSecondDurationLectureValue;
                          //  kThirdDurationLectureValue;
                          //
                          //  kFirstDurationSectionValue;
                          //  kSecondDurationSectionValue;
                          // getCase.lectureDurationSwitchCase(kLectureTime.toString());
                          // getCase.sectionDurationSwitchCase(kSectionTime.toString());
                          // print('first =$kFirstDurationLectureValue');
                          // print('second =$kSecondDurationLectureValue');
                          // print('third =$kThirdDurationLectureValue');
                          // print('first =$kFirstDurationSectionValue');
                          // print('second =$kSecondDurationSectionValue');
                          // getData.addSubject(
                          //     kDepartmentValue.toString(),
                          //     kSubjectController.text,
                          //     kSubjectCodeController.text,
