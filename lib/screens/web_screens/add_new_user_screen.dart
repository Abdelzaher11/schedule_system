...
class WebAddNewUserScreen extends StatefulWidget {
  @override
  _WebAddNewUserScreenState createState() => _WebAddNewUserScreenState();
}

class _WebAddNewUserScreenState extends State<WebAddNewUserScreen> {
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Checkbox(
                              value: kCheckButtonWebAddUserShowPassword,
                              onChanged: (change) {
                                setState(() {
                                  kCheckButtonWebAddUserShowPassword = change!;
                                  // ignore: avoid_print
                                  print(kCheckButtonWebAddUserShowPassword);
                                });
                              }),
                        ),
